...
/**
 * Error code indicating the Nonce
 * is expired
 * @property NONCE_EXPIRED
 * @static
 * @final
 */
CoreError.NONCE_EXPIRED = 603;

/**
 * Error code indicating the Nonce
 * is invalid either due to a hash mismatch
 * or incorrect length
 * @property NONCE_INVALID
 * @static
 * @final
 */
CoreError.NONCE_INVALID = 604;

/**
 * Error code indicating the Nonce
 * is invalid becuase it has already
 * been used
 * @property NONCE_USED
 * @static
 * @final
 */
CoreError.NONCE_USED = 605;
 
/**
 * Error code indicating that Card
 * object is invalid either becuase
 * the number, month, year or cvv code
 * is invalid
 */
CoreError.CARD_INVALID = 606;
